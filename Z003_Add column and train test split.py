...
# df['discrete_action'] = df['vaso_input'] * df['iv_input']
...
df['reward'] = 0
df.loc[((df['bloc'] == 80) & (df['OutC002_90d mortality'] == 1)), 'reward'] = -15
df.loc[((df['bloc'] == 80) & (df['OutC002_90d mortality'] == 0)), 'reward'] = 15
